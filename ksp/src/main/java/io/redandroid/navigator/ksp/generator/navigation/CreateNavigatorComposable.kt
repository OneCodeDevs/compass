...
import io.redandroid.navigator.ksp.generator.START_DESTINATION
...
internal fun createNavigatorComposable(destinations: List<DestinationDescription>): FunSpec {
	...
	return FunSpec.builder(NAVIGATOR_COMPOSABLE_NAME)
		...
		.beginControlFlow("NavHost(startDestination = %L, navController = navHostController)", START_DESTINATION)
