...
import de.onecode.navigator.ksp.writeToString
	...
	fun `Two destinations not top and no subgraph`() {
		...
		assertThat(code)
			.isEqualTo(
				...
				|import de.onecode.navigator.runtime.CommonContext
				|import de.onecode.navigator.runtime.LocalNavHostController
