...
class CreateNavigatorControllerTest {
	@Test
	fun `NavigatorController with one Destination no top`() {
		...
		val code = buildTestFile {
			addType(createNavigatorController(listOf(description)))
		}
	...
	@Test
	fun `NavigatorController with two Destination no top`() {
		...
		val code = buildTestFile {
			addType(createNavigatorController(listOf(description1, description2)))
		}
	...
	@Test
	fun `NavigatorController with two Destination and one top`() {
		val param1 = ParameterDescription("param1", "kotlin.Int")
		val description1 = DestinationDescription(
			name = "foo",
			parameters = emptyList(),
